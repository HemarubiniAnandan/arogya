          ...
          {step === 1 && (
            <div className="space-y-4">
              ...
              <div className="bg-slate-50 p-4 rounded-xl border border-slate-200 space-y-3">
                ...
                <div>
                  <div className="flex justify-between items-center mb-1">
                    <label className="block text-xs font-semibold text-slate-700">ABHA ID (Ayushman Bharat Health Account)</label>
                    <a
                    ...
                    >
                      <Shield className="w-3 h-3 text-blue-600" /> Create Official ABHA ID on Govt Portal (abha.abdm.gov.in) ↗
                    </a>
                  </div>
                  <div className="flex gap-2">
                    <input
                      type="text"
                      placeholder="Enter 14-digit ABHA Number (e.g. 91-4412-8819-2041)"
                      value={abhaId}
                      onChange={e => setAbhaId(e.target.value)}
                      className="flex-1 px-3 py-2 text-sm rounded-xl border border-slate-300 bg-white font-mono focus:outline-emerald-600"
                    />
                    <a
                      href="https://abha.abdm.gov.in/abha/v3/register"
                      target="_blank"
                      rel="noopener noreferrer"
                      className="px-3.5 py-2 bg-blue-700 hover:bg-blue-800 text-white rounded-xl text-xs font-bold flex items-center gap-1.5 shrink-0 shadow-xs"
                    >
