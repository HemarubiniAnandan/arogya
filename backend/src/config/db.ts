  ...
  const mockPatients = [
    {
      ...
      village: 'Morgaon',
      pincode: '412304',
      chronicConditions: JSON.stringify(['Type 2 Diabetes', 'Mild Hypertension']),
      allergies: JSON.stringify(['Penicillin']),
      currentMedications: JSON.stringify(['Metformin 500mg (1-0-1)', 'Amlodipine 5mg (0-0-1)']),
      emergencyContact: JSON.stringify({ name: 'Sunita Jadhav', phone: '9822014590', relation: 'Spouse' }),
    ...
    },
    {
      ...
      village: 'Morgaon',
      pincode: '412304',
      chronicConditions: JSON.stringify(['Gestational Anemia (Hb 9.2 g/dL)']),
      allergies: JSON.stringify([]),
      currentMedications: JSON.stringify(['IFA Tablets', 'Calcium 500mg']),
      emergencyContact: JSON.stringify({ name: 'Sanjay Patil', phone: '9765412310', relation: 'Husband' }),
      consent: JSON.stringify({ allowAshaAssistance: true, allowRecordSharing: true, allowReferralSharing: true, allowTeleconsultSharing: true }),
      isHighRisk: 1,
    ...
    },
    {
      ...
      emergencyContact: JSON.stringify({ name: 'Sunita Pawar', phone: '9421087654', relation: 'Mother' }),
      consent: JSON.stringify({ allowAshaAssistance: true, allowRecordSharing: true, allowReferralSharing: true, allowTeleconsultSharing: true }),
      isHighRisk: 0,
    ...
    },
    {
      ...
      currentMedications: JSON.stringify(['Salbutamol Inhaler PRN']),
      emergencyContact: JSON.stringify({ name: 'Pooja Kumar', phone: '9850123457', relation: 'Wife' }),
      consent: JSON.stringify({ allowAshaAssistance: true, allowRecordSharing: true, allowReferralSharing: true, allowTeleconsultSharing: true }),
      isHighRisk: 0,
      highRiskCategory: ''
    }
  ...
  const mockAppointments = [
    {
      ...
      status: 'ARRIVED',
      statusHistory: JSON.stringify([{ stage: 'ARRIVED', timestamp: new Date().toISOString(), updatedBy: 'Surekha Tai Shinde', role: 'asha', hospitalName: 'PHC Morgaon' }]),
      queuePosition: 1,
      estimatedWaitMins: 10,
      qrCodeData: 'MH-TOKEN-PAT-1001-APT-881',
